...
namespace weatherlogr.Repository.MySql.Migrations
{
    ...
    [Migration("20230513041650_Index_Radar")]
    partial class IndexRadar
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("weatherlogr.Repository.MySql.Models.RadarSource", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("weatherlogr.Repository.MySql.RadarIndex", b =>
                {
                    b.HasOne("weatherlogr.Repository.MySql.Models.RadarSource", "RadarSource")
                        .WithMany()
                        .HasForeignKey("RadarSourceID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("RadarSource");
                });
